module.exports = (deps) => {
  return function runWebpack({
    isoPlugin, modulePaths, mapPath, externals, minify, outputFileSystem, componentFiles, definitions
  } = {}) {
    const {
    ...
    function run() {
      const webpackConfig = createWebpackConfig({
        isoPlugin, modulePaths, mapPath, externals, minify, componentFiles, definitions
      });
